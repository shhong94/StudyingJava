...
public class 자바메소드4응용2 {
	...
	static void movieData(int input) throws Exception{
		String[] site = {
		...
		System.out.println("★★★★★" + subjects[input-1] + "★★★★★");

		Document doc = Jsoup.connect(site[input-1]).get();
		Elements title = doc.select("div_info_tit name_movie");
