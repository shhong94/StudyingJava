...
// 회원가입 창
// JoinForm이 JPanel의 모든 기능을 갖고 온다 (JoinForm == JPanel)
...
// 초기화 ======================================================================== 초기화
	public JoinForm() {
		...
		la11 = new JLabel("선호 장르", JLabel.RIGHT);
		...
		box1 = new JCheckBox("로맨스");
		box2 = new JCheckBox("코미디");
		box3 = new JCheckBox("SF");
		box4 = new JCheckBox("공포");
		box5 = new JCheckBox("드라마");
		...
		ButtonGroup gb = new ButtonGroup();		// 라디오버튼은 버튼그룹을 지정해야 한개씩만 선택됨
		gb.add(rb1);
		gb.add(rb2);
...
// 배치 ============================================================================= 배치
		...
		// 아이디
		la1.setBounds(300, 100, 80, 30); 	// 가로는 한글자당 20px, 높이는 30정도
		...
		add(la11); add(p);
		// 회원가입 / 취소 버튼
		JPanel p2 = new JPanel();			// jpanel 안에 넣어야 가운데 정렬이 됨
		p2.add(b3); p2.add(b4);
